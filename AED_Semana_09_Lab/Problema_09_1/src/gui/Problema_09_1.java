...
public class Problema_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Nombre primer alumno Desaprobado :  " + aa.nombrePrimerDesaprobado());
		imprimir("Nombre ultimo alumno Aprobado :  " + aa.nombreUltimoAprobado());
		imprimir("Nombre Segundo alumno Desaprobado :  " + aa.nombreSegundoDesaprobado());
		imprimir("Nombre Penultimo alumno Aprobado :  " + aa.nombrePenultimoAprobado());
